...
public class Server {
    ...
    // 사용자 폴더의 위치를 읽어와서 파일 위치 지정
    private static final File serverFolder = new File(System.getProperty("user.home") + "/chatserver/");
    private static final File serverSaveFile = new File(serverFolder, "last_id.txt");
